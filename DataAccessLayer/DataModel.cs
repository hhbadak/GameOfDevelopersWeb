...
namespace DataAccessLayer
{
    public class DataModel
    {
        ...
        public List<Uye> uyeListele()
        {
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    u.durumStr = reader.GetBoolean(6) ? "<label style='color:green'>Aktif</label>" : "<label style='color:darkred'>Askıya Alınmış</label>";
                    list.Add(u);
                }
                return list;
            }
        ...
        public bool uyeAskiyaAl(int id)
        {
            try
            {
        ...
        public bool uyeAskiKaldir(int id)
        {
            try
            {
